...
wget https://orthanc.uclouvain.be/downloads/third-party-downloads/Python/python-3.10.10-win64.zip
unzip python-3.10.10-win64.zip
...
cmake /tmp/source-writeable/ \
      ...
      -DPYTHON_WINDOWS_ROOT=/tmp/build/python-3.10.10-win64 \
