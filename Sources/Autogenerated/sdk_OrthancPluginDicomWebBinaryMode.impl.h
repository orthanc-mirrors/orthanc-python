...
{
  PyObject_HEAD
} sdk_OrthancPluginDicomWebBinaryMode_Object;
 ...
 **/
static PyTypeObject sdk_OrthancPluginDicomWebBinaryMode_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "orthanc.DicomWebBinaryMode",    /* tp_name */
  sizeof(sdk_OrthancPluginDicomWebBinaryMode_Object), /* tp_basicsize */
};


void RegisterOrthancPluginDicomWebBinaryModeEnumeration(PyObject* module)
{
  sdk_OrthancPluginDicomWebBinaryMode_Type.tp_new = PyType_GenericNew;
  sdk_OrthancPluginDicomWebBinaryMode_Type.tp_flags = Py_TPFLAGS_DEFAULT;
  sdk_OrthancPluginDicomWebBinaryMode_Type.tp_doc = "Generated from C enumeration OrthancPluginOrthancPluginDicomWebBinaryMode";  

  sdk_OrthancPluginDicomWebBinaryMode_Type.tp_dict = PyDict_New();
