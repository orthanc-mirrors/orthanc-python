...
{
  PyObject_HEAD
} sdk_OrthancPluginCreateDicomFlags_Object;
 ...
 **/
static PyTypeObject sdk_OrthancPluginCreateDicomFlags_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "orthanc.CreateDicomFlags",    /* tp_name */
  sizeof(sdk_OrthancPluginCreateDicomFlags_Object), /* tp_basicsize */
};


void RegisterOrthancPluginCreateDicomFlagsEnumeration(PyObject* module)
{
  sdk_OrthancPluginCreateDicomFlags_Type.tp_new = PyType_GenericNew;
  sdk_OrthancPluginCreateDicomFlags_Type.tp_flags = Py_TPFLAGS_DEFAULT;
  sdk_OrthancPluginCreateDicomFlags_Type.tp_doc = "Generated from C enumeration OrthancPluginOrthancPluginCreateDicomFlags";  

  sdk_OrthancPluginCreateDicomFlags_Type.tp_dict = PyDict_New();
