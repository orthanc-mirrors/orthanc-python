...
{
  PyObject_HEAD
} sdk_OrthancPluginDicomToJsonFormat_Object;
 ...
 **/
static PyTypeObject sdk_OrthancPluginDicomToJsonFormat_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "orthanc.DicomToJsonFormat",    /* tp_name */
  sizeof(sdk_OrthancPluginDicomToJsonFormat_Object), /* tp_basicsize */
};


void RegisterOrthancPluginDicomToJsonFormatEnumeration(PyObject* module)
{
  sdk_OrthancPluginDicomToJsonFormat_Type.tp_new = PyType_GenericNew;
  sdk_OrthancPluginDicomToJsonFormat_Type.tp_flags = Py_TPFLAGS_DEFAULT;
  sdk_OrthancPluginDicomToJsonFormat_Type.tp_doc = "Generated from C enumeration OrthancPluginOrthancPluginDicomToJsonFormat";  

  sdk_OrthancPluginDicomToJsonFormat_Type.tp_dict = PyDict_New();
