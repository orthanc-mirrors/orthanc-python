...
{
  PyObject_HEAD
} sdk_OrthancPluginJobStepStatus_Object;
 ...
 **/
static PyTypeObject sdk_OrthancPluginJobStepStatus_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "orthanc.JobStepStatus",    /* tp_name */
  sizeof(sdk_OrthancPluginJobStepStatus_Object), /* tp_basicsize */
};


void RegisterOrthancPluginJobStepStatusEnumeration(PyObject* module)
{
  sdk_OrthancPluginJobStepStatus_Type.tp_new = PyType_GenericNew;
  sdk_OrthancPluginJobStepStatus_Type.tp_flags = Py_TPFLAGS_DEFAULT;
  sdk_OrthancPluginJobStepStatus_Type.tp_doc = "Generated from C enumeration OrthancPluginOrthancPluginJobStepStatus";  

  sdk_OrthancPluginJobStepStatus_Type.tp_dict = PyDict_New();
