...
{
  PyObject_HEAD
} sdk_OrthancPluginIdentifierConstraint_Object;
 ...
 **/
static PyTypeObject sdk_OrthancPluginIdentifierConstraint_Type = {
  PyVarObject_HEAD_INIT(NULL, 0)
  "orthanc.IdentifierConstraint",    /* tp_name */
  sizeof(sdk_OrthancPluginIdentifierConstraint_Object), /* tp_basicsize */
};


void RegisterOrthancPluginIdentifierConstraintEnumeration(PyObject* module)
{
  sdk_OrthancPluginIdentifierConstraint_Type.tp_new = PyType_GenericNew;
  sdk_OrthancPluginIdentifierConstraint_Type.tp_flags = Py_TPFLAGS_DEFAULT;
  sdk_OrthancPluginIdentifierConstraint_Type.tp_doc = "Generated from C enumeration OrthancPluginOrthancPluginIdentifierConstraint";  

  sdk_OrthancPluginIdentifierConstraint_Type.tp_dict = PyDict_New();
